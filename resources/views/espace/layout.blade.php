...
<body>
	<section class="billboard light">
		<header class="wrapper light">
			<a href="{{URL::to('/')}}"><img class="logo" src={{ asset('img/logo_light.png') }} alt=""/></a>
			<nav>
				<ul>
					...
					@else
						@if($user->role == 'company')
							<li>{{ Html::link('perso/projet', 'Mes Projets') }}</li>
						@elseif($user->role == 'freelancer')
							<li>{{ Html::link('perso/offres', 'Mes Offres') }}</li>
						@endif
   ...
   <!-- <script src='../ga.js'></script>-->
	...
	{{ Html::script('js/fancybox-buttons.js') }}
	{{ Html::script('fancybox-media.js') }}
	{{ Html::script('js/fancybox-thumbs.js') }}
